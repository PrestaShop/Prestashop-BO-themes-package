 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:E}=window,x=function(t,e){E.post(t).then((()=>window.location.assign(e)))},{$:O}=window;class B{extend(t){t.getContainer().on("click",f,(t=>{x(O(t.currentTarget).data("url"),O(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class T{extend(t){const e=t.getContainer().find(h);new A(e).attach()}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Ot}=window;class Bt{constructor(t){this.onClick=t}extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",e.linkRowAction,(t=>{const e=Ot(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){const n=this.onClick;Ot("tr",t.getContainer()).each((function(){const t=Ot(this);Ot(e.linkRowActionClickableFirst,t).each((function(){const o=Ot(this),i=o.closest("td"),r=Ot(e.clickableTd,t).not(i);let s=!1;r.addClass("cursor-pointer").on("mousedown",(()=>{Ot(window).on("mousemove",(()=>{s=!0,Ot(window).off("mousemove")}))})),r.on("mouseup",(()=>{const t=s;if(s=!1,Ot(window).off("mousemove"),!t){const t=o.data("confirm-message");(!t.length||window.confirm(t)&&o.attr("href"))&&(N(n)||N(o.get(0))?document.location.href=o.attr("href"):n(o.get(0)))}}))}))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @copyright Since 2007 PrestaShop SA and Contributors
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */const jt=".js-form-submit-btn",{$:At}=window;class Tt{constructor(){At(document).on("click",jt,(t=>{t.preventDefault();const e=At(t.target);if(e.data("form-confirm-message")&&!1===window.confirm(e.data("form-confirm-message")))return;let n="POST",o=null;if(e.data("method")){const t=e.data("method"),i=["GET","POST"].includes(t);n=i?t:"POST",i||(o=At("<input>",{type:"_hidden",name:"_method",value:t}))}const i=At("<form>",{action:e.data("form-submit-url"),method:n});o&&i.append(o),e.data("form-csrf-token")&&i.append(At("<input>",{type:"_hidden",name:"_csrf_token",value:e.data("form-csrf-token")})),i.appendTo("body").submit()}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:$t}=window;$t((()=>{const t=new C("tax_rules_group");t.addExtension(new B),t.addExtension(new T),t.addExtension(new S),t.addExtension(new L),t.addExtension(new F),t.addExtension(new Ct),t.addExtension(new xt),t.addExtension(new Bt),t.addExtension(new Mt),t.addExtension(new Lt),new Tt}))})(),window.tax_rules_group=o})();