 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:F}=window;class I{extend(t){t.getContainer().find(f).find(m).on("click",(t=>{t.preventDefault(),this.toggleValue(F(t.delegateTarget))}))}toggleValue(t){const e=t.data("toggleUrl");this.submitAsForm(e)}submitAsForm(t){F("<form>",{action:t,method:"POST"}).appendTo("body").submit()}}var P=n(9567),D=Object.defineProperty,R=Object.getOwnPropertySymbols,q=Object.prototype.hasOwnProperty,H=Object.prototype.propertyIsEnumerable,G=(t,e,n)=>e in t?D(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,z=(t,e)=>{for(var n in e||(e={}))q.call(e,n)&&G(t,n,e[n]);if(R)for(var n of R(e))H.call(e,n)&&G(t,n,e[n]);return t};
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Bt}=window;class Tt{extend(t){this.handleBulkActionCheckboxStatus(t),this.handleBulkActionCheckboxSelect(t),this.handleBulkActionSelectAllCheckbox(t)}handleBulkActionCheckboxStatus(t){t.getContainer().find(r.actionSelectAll).prop("disabled",0===t.getContainer().find(r.bulkActionCheckbox).length)}handleBulkActionSelectAllCheckbox(t){t.getContainer().on("change",r.actionSelectAll,(e=>{const n=Bt(e.currentTarget).is(":checked");n?this.enableBulkActionsBtn(t):this.disableBulkActionsBtn(t),t.getContainer().find(r.bulkActionCheckbox).prop("checked",n)}))}handleBulkActionCheckboxSelect(t){t.getContainer().on("change",r.bulkActionCheckbox,(()=>{t.getContainer().find(r.checkedCheckbox).length>0?this.enableBulkActionsBtn(t):this.disableBulkActionsBtn(t)}))}enableBulkActionsBtn(t){t.getContainer().find(r.bulkActionBtn).prop("disabled",!1)}disableBulkActionsBtn(t){t.getContainer().find(r.bulkActionBtn).prop("disabled",!0)}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:St}=window;class Lt{constructor(t){this.onClick=t}extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",s.linkRowAction,(t=>{const e=St(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){const e=this.onClick;St("tr",t.getContainer()).each((function(){const t=St(this);St(s.linkRowActionClickableFirst,t).each((function(){const n=St(this),o=n.closest("td"),i=St(s.clickableTd,t).not(o);let r=!1;i.addClass("cursor-pointer").on("mousedown",(()=>{St(window).on("mousemove",(()=>{r=!0,St(window).off("mousemove")}))})),i.on("mouseup",(()=>{const t=r;if(r=!1,St(window).off("mousemove"),!t){const t=n.data("confirm-message");(!t.length||window.confirm(t)&&n.attr("href"))&&(Q(e)||Q(n.get(0))?document.location.href=n.attr("href"):e(n.get(0)))}}))}))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:$t}=window;$t((()=>{["manufacturer","manufacturer_address"].forEach((t=>{const e=new x(t);e.addExtension(new At),e.addExtension(new $),e.addExtension(new j),e.addExtension(new L),e.addExtension(new I),e.addExtension(new Et),e.addExtension(new xt),e.addExtension(new Tt),e.addExtension(new Mt),e.addExtension(new Lt)})),window.prestashop.component.initComponents(["TranslatableInput","TranslatableField","TinyMCEEditor"]),new window.prestashop.component.TaggableField({tokenFieldSelector:"input.js-taggable-field",options:{createTokensOnBlur:!0}}),new window.prestashop.component.ChoiceTree("#manufacturer_shop_association").enableAutoCheckChildren(),new i}))})(),window.manufacturer=o})();