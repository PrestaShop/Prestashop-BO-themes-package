 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class ${extend(t){const e=t.getContainer().find(h);new S(e).attach()}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:$t}=window;class Lt{constructor(){const t=new C("state");t.addExtension(new A),t.addExtension(new $),t.addExtension(new B),t.addExtension(new E),t.addExtension(new I),t.addExtension(new Ct),t.addExtension(new Ot),t.addExtension(new Mt),t.addExtension(new At),t.addExtension(new xt),t.addExtension(new St)}}$t((()=>{new Lt}))})(),window.state=o})();