 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class y{extend(t){t.getHeaderContainer().on("click",f,(()=>{window.location.reload()}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:w}=window;class _{extend(t){t.getHeaderContainer().on("click",i.showQuery,(()=>this.onShowSqlQueryClick(t))),t.getHeaderContainer().on("click",i.exportQuery,(()=>this.onExportSqlManagerClick(t)))}onShowSqlQueryClick(t){const e=w(i.showModalForm(t.getId()));this.fillExportForm(e,t);const n=w(i.showModalGrid(t.getId()));n.modal("show"),n.on("click",b,(()=>e.submit()))}onExportSqlManagerClick(t){const e=w(i.showModalForm(t.getId()));this.fillExportForm(e,t),e.submit()}fillExportForm(t,e){const n=e.getContainer().find(s).data("query");t.find('textarea[name="sql"]').val(n),t.find('input[name="name"]').val(this.getNameFromBreadcrumb())}getNameFromBreadcrumb(){const t=w(u).find(h);let e="";return t.each(((t,n)=>{const o=w(n),i=o.find("a").length>0?o.find("a").text():o.text();e.length>0&&(e=e.concat(" > ")),e=e.concat(i)})),e}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class At{constructor(){const t=new v("contact");t.addExtension(new y),t.addExtension(new _),t.addExtension(new L),t.addExtension(new j),t.addExtension(new T),t.addExtension(new S),t.addExtension(new wt),t.addExtension(new Ct),t.addExtension(new xt),new Ot,new Bt("#contact_shop_association").enableAutoCheckChildren()}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
