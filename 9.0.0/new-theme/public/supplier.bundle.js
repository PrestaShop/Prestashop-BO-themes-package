 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class Tt{extend(t){const e=t.getContainer().find(b);e.find(p).prop("disabled",!0),e.find(w).on("input dp.change",(()=>{e.find(p).prop("disabled",!1),e.find(g).prop("hidden",!1)}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Lt}=window;Lt((()=>{const t=new C("supplier");t.addExtension(new B),t.addExtension(new S),t.addExtension(new T),t.addExtension(new $),t.addExtension(new kt),t.addExtension(new Et),t.addExtension(new Bt),t.addExtension(new Ot),t.addExtension(new At),t.addExtension(new Tt),t.addExtension(new St)}))})(),window.supplier=o})();