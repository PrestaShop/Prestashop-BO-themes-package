 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:A}=window,M=function(t,e){A.post(t).then((()=>window.location.assign(e)))},{$:T}=window;class S{extend(t){t.getContainer().on("click",m,(t=>{M(T(t.currentTarget).data("url"),T(t.currentTarget).data("redirect"))}))}}var L=n(9567),$=Object.defineProperty,I=Object.getOwnPropertySymbols,F=Object.prototype.hasOwnProperty,P=Object.prototype.propertyIsEnumerable,D=(t,e,n)=>e in t?$(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,R=(t,e)=>{for(var n in e||(e={}))F.call(e,n)&&D(t,n,e[n]);if(I)for(var n of I(e))P.call(e,n)&&D(t,n,e[n]);return t};
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:jt}=window;jt((()=>{const t=new k("search_engine");t.addExtension(new E),t.addExtension(new B),t.addExtension(new j),t.addExtension(new S),t.addExtension(new _t),t.addExtension(new kt),t.addExtension(new Et),t.addExtension(new Bt),t.addExtension(new Ot)}))})(),window.search_engine=o})();