 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:v}=window,y=function(t,e){v.post(t).then((()=>window.location.assign(e)))},{$:_}=window;class k{extend(t){t.getContainer().on("click",m,(t=>{y(_(t.currentTarget).data("url"),_(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:_t}=window;class kt{constructor(t){this.onClick=t}extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",e.linkRowAction,(t=>{const e=_t(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){const n=this.onClick;_t("tr",t.getContainer()).each((function(){const t=_t(this);_t(e.linkRowActionClickableFirst,t).each((function(){const o=_t(this),i=o.closest("td"),s=_t(e.clickableTd,t).not(i);let r=!1;s.addClass("cursor-pointer").on("mousedown",(()=>{_t(window).on("mousemove",(()=>{r=!0,_t(window).off("mousemove")}))})),s.on("mouseup",(()=>{const t=r;if(r=!1,_t(window).off("mousemove"),!t){const t=o.data("confirm-message");(!t.length||window.confirm(t)&&o.attr("href"))&&(q(n)||q(o.get(0))?document.location.href=o.attr("href"):n(o.get(0)))}}))}))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:xt}=window;xt((()=>{const t=new w("address");t.addExtension(new k),t.addExtension(new B),t.addExtension(new O),t.addExtension(new j),t.addExtension(new M),t.addExtension(new wt),t.addExtension(new yt),t.addExtension(new kt),new Bt}))})(),window.address=o})();