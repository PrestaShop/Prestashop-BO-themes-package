 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:L}=window,j=function(t,e){L.post(t).then((()=>window.location.assign(e)))},{$:O}=window;class B{extend(t){t.getContainer().on("click",m,(t=>{j(O(t.currentTarget).data("url"),O(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class M{extend(t){const e=t.getContainer().find(d);new A(e).attach()}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:At}=window;class Mt{extend(t){const e=t.getContainer();e.on("click",".js-remove-helper-block",(t=>{e.remove();const n=At(t.target),o=n.data("closeUrl"),i=n.data("cardName");o&&At.post(o,{close:1,name:i})}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:zt}=window;zt((()=>{const t=new C("meta");t.addExtension(new k),t.addExtension(new E),t.addExtension(new B),t.addExtension(new M),t.addExtension(new I),t.addExtension(new F),t.addExtension(new xt),t.addExtension(new Ot),t.addExtension(new Lt),t.addExtension(new Rt);new St("seo-urls-showcase-card").addExtension(new Mt),new $t({tokenFieldSelector:"input.js-taggable-field",options:{createTokensOnBlur:!0}}),new Ft,new qt,window.prestashop.component.initComponents(["MultistoreConfigField"]),new Wt}))})(),window.meta=o})();