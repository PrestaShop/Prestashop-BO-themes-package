 ...
 * @copyright Since 2007 PrestaShop SA and Contributors
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */const d="#customer_address_customer_email",p="#customer_address_first_name",l="#customer_address_last_name",h="#customer_address_company",y="#customer_address_id_country",g="#customer_address_id_state",$=".js-address-state-select",m="#customer_address_dni",I='label[for="customer_address_dni"]',_="#customer_address_postcode",S='label[for="customer_address_postcode"]',{$:w}=window;w((()=>{new o(d,{firstName:p,lastName:l,company:h}),new r(y,g,$),new a(y,m,I),new u(y,_,S)})),window.customer_address_form=e})();