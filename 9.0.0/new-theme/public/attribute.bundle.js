 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class B{extend(t){const e=t.getContainer().find(m);new A(e).attach()}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:E}=window,S=function(t,e){E.post(t).then((()=>window.location.assign(e)))},{$:M}=window;class L{extend(t){t.getContainer().on("click",g,(t=>{S(M(t.currentTarget).data("url"),M(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class Bt{extend(t){const e=t.getContainer().find(v);e.find(w).prop("disabled",!0),e.find(D).on("input dp.change",(()=>{e.find(w).prop("disabled",!1),e.find(y).prop("hidden",!1)}))}}n(3867);
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Mt}=window;class Lt{constructor(t){this.onClick=t}extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",e.linkRowAction,(t=>{const e=Mt(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){const n=this.onClick;Mt("tr",t.getContainer()).each((function(){const t=Mt(this);Mt(e.linkRowActionClickableFirst,t).each((function(){const o=Mt(this),i=o.closest("td"),r=Mt(e.clickableTd,t).not(i);let s=!1;r.addClass("cursor-pointer").on("mousedown",(()=>{Mt(window).on("mousemove",(()=>{s=!0,Mt(window).off("mousemove")}))})),r.on("mouseup",(()=>{const t=s;if(s=!1,Mt(window).off("mousemove"),!t){const t=o.data("confirm-message");(!t.length||window.confirm(t)&&o.attr("href"))&&(W(n)||W(o.get(0))?document.location.href=o.attr("href"):n(o.get(0)))}}))}))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Pt}=window;Pt((()=>{const t=new T("attribute");t.addExtension(new At),t.addExtension(new P),t.addExtension(new B),t.addExtension(new L),t.addExtension(new Ct),t.addExtension(new Ot),t.addExtension(new Tt),t.addExtension(new Bt),t.addExtension(new St(t)),t.addExtension(new Lt)}))})(),window.attribute=o})();