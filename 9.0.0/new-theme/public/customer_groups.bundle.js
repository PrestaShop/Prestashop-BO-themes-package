 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Tt}=window;Tt((()=>{const t=new C("customer_groups");t.addExtension(new x),t.addExtension(new mt),t.addExtension(new bt),t.addExtension(new wt),t.addExtension(new kt),t.addExtension(new Ct),t.addExtension(new xt),t.addExtension(new Ot),t.addExtension(new jt),t.addExtension(new Mt)}))})(),window.customer_groups=o})();