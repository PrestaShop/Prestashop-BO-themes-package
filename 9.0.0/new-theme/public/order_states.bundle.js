 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:B}=window,O=function(t,e){B.post(t).then((()=>window.location.assign(e)))},{$:j}=window;class M{extend(t){t.getContainer().on("click",m,(t=>{O(j(t.currentTarget).data("url"),j(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class S{extend(t){const e=t.getContainer().find(l);new T(e).attach()}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Ot}=window;class jt{extend(e){e.getHeaderContainer().on("click",t.gridSubmitAction,(t=>{this.handleSubmit(t,e)}))}handleSubmit(t,n){const o=Ot(t.currentTarget),i=o.data("confirm-message");if(void 0!==i&&i.length>0&&!window.confirm(i))return;const r=Ot(v(n.getId()));r.attr("action",o.data("url")),r.attr("method",o.data("method")),r.find(e.tokenInput(n.getId())).val(o.data("csrf")),r.submit()}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class Mt{extend(t){const e=t.getContainer().find(f);e.find(b).prop("disabled",!0),e.find(g).on("input dp.change",(()=>{e.find(b).prop("disabled",!1),e.find(p).prop("hidden",!1)}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:At}=window;At((()=>{const t=new k("order_states");t.addExtension(new M),t.addExtension(new Mt),t.addExtension(new S),t.addExtension(new x),t.addExtension(new C),t.addExtension(new Et),t.addExtension(new jt),t.addExtension(new kt),t.addExtension(new Bt),t.addExtension(new $);const e=new k("order_return_states");e.addExtension(new M),e.addExtension(new Mt),e.addExtension(new S),e.addExtension(new x),e.addExtension(new C),e.addExtension(new Et),e.addExtension(new jt),e.addExtension(new kt),e.addExtension(new Bt)}))})(),window.order_states=o})();