 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:x}=window,B=function(t,e){x.post(t).then((()=>window.location.assign(e)))},{$:O}=window;class A{extend(t){t.getContainer().on("click",b,(t=>{B(O(t.currentTarget).data("url"),O(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class ${extend(t){const e=t.getContainer().find(u);new L(e).attach()}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class Bt{extend(t){const e=t.getContainer().find(p);e.find(g).prop("disabled",!0),e.find(v).on("input dp.change",(()=>{e.find(g).prop("disabled",!1),e.find(w).prop("hidden",!1)}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Ot}=window;class At{constructor(){this.lockArray=[]}extend(e){e.getContainer().find(t.choiceOptions).find(h).on("click",(e=>{e.preventDefault();const n=Ot(e.currentTarget),o=n.closest(t.choiceOptions).data("url");this.submitForm(o,n)}))}submitForm(t,e){const n=e.data("value");if(this.isLocked(t))return;const o=Ot("<form>",{action:t,method:"POST"}).append(Ot("<input>",{name:"value",value:n,type:"hidden"}));o.appendTo("body"),o.submit(),this.lock(t)}isLocked(t){return this.lockArray.includes(t)}lock(t){this.lockArray.push(t)}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:jt}=window;class Tt{constructor(t){this.onClick=t}extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",e.linkRowAction,(t=>{const e=jt(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){const n=this.onClick;jt("tr",t.getContainer()).each((function(){const t=jt(this);jt(e.linkRowActionClickableFirst,t).each((function(){const o=jt(this),i=o.closest("td"),r=jt(e.clickableTd,t).not(i);let s=!1;r.addClass("cursor-pointer").on("mousedown",(()=>{jt(window).on("mousemove",(()=>{s=!0,jt(window).off("mousemove")}))})),r.on("mouseup",(()=>{const t=s;if(s=!1,jt(window).off("mousemove"),!t){const t=o.data("confirm-message");(!t.length||window.confirm(t)&&o.attr("href"))&&(Q(n)||Q(o.get(0))?document.location.href=o.attr("href"):n(o.get(0)))}}))}))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Mt}=window;class St{extend(t){t.getContainer().find(u).find(d).on("click",(t=>{t.preventDefault(),this.toggleValue(Mt(t.delegateTarget))}))}toggleValue(t){const e=t.data("toggleUrl");this.submitAsForm(e)}submitAsForm(t){Mt("<form>",{action:t,method:"POST"}).appendTo("body").submit()}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Ft}=window;class It{extend(t){t.getContainer().on("click",e.imageTypeDeleteAction,(n=>{n.preventDefault();const o=Ft(n.currentTarget),i=Ft(e.deleteImageTypeModal(t.getId()));i.modal("show"),i.on("click",e.submitDeleteImageType,(()=>{const t=i.find("form");t.attr("action",o.data("delete-url")),t.submit()}))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Dt}=window;Dt((()=>{const t=new E("image_type");t.addExtension(new A),t.addExtension(new j),t.addExtension(new M),t.addExtension(new $),t.addExtension(new Tt),t.addExtension(new xt),t.addExtension(new I),t.addExtension(new Bt),t.addExtension(new At),t.addExtension(new St),t.addExtension(new $t),t.addExtension(new It);const e=Dt("form[name=regenerate_thumbnails]"),n=Dt("#regenerate-thumbnails-button"),o=Dt("#regenerate_thumbnails_image"),i=Dt("#regenerate_thumbnails_image-type"),r=i.parents(".form-group"),s=o.data("formats");r.hide(),o.on("change",(()=>{var t;const e=(null!=(t=o.val())?t:"all").toString();i.val(0),i.children("option").hide(),"all"===e?r.hide():(r.show(),s[e].forEach((t=>{i.children(`option[value="${t}"]`).show()})),i.children('option[value="0"]').show())})),n.on("click",(t=>{t.preventDefault();new tt({id:"regeneration-confirm-modal",confirmTitle:n.data("confirm-title"),confirmMessage:n.data("confirm-message"),closeButtonLabel:n.data("confirm-cancel"),confirmButtonLabel:n.data("confirm-apply"),closable:!0},(()=>{e.submit()})).show()}))}))})(),window.image_settings=o})();