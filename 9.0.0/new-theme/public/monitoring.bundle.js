 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class A{extend(t){const e=t.getContainer().find(h);new M(e).attach()}}var T=n(9567),S=Object.defineProperty,$=Object.getOwnPropertySymbols,L=Object.prototype.hasOwnProperty,D=Object.prototype.propertyIsEnumerable,I=(t,e,n)=>e in t?S(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,F=(t,e)=>{for(var n in e||(e={}))L.call(e,n)&&I(t,n,e[n]);if($)for(var n of $(e))D.call(e,n)&&I(t,n,e[n]);return t};
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Tt}=window;class St{constructor(t){this.id=t,this.$container=Tt(`#${this.id}`)}getContainer(){return this.$container}addExtension(t){t.extend(this)}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:$t}=window;class Lt{extend(t){const e=t.getContainer();e.on("click",".js-remove-helper-block",(t=>{e.remove();const n=$t(t.target),o=n.data("closeUrl"),i=n.data("cardName");o&&$t.post(o,{close:1,name:i})}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Ft}=window;Ft((()=>{const t=new C("empty_category");t.addExtension(new O),t.addExtension(new A),t.addExtension(new jt),t.addExtension(new _t),t.addExtension(new kt),t.addExtension(new Bt),t.addExtension(new Et),t.addExtension(new Ot),["no_qty_product_with_combination","no_qty_product_without_combination","disabled_product","product_without_image","product_without_description","product_without_price"].forEach((t=>{const e=new C(t);e.addExtension(new A),e.addExtension(new At),e.addExtension(new jt),e.addExtension(new O),e.addExtension(new Bt),e.addExtension(new _t),e.addExtension(new It),e.addExtension(new wt),e.addExtension(new kt),e.addExtension(new Ot)}));new St("monitoringShowcaseCard").addExtension(new Lt)}))})(),window.monitoring=o})();