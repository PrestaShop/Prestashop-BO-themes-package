 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Tt}=window;Tt((()=>{const t=new C("country");t.addExtension(new O),t.addExtension(new M),t.addExtension(new S),t.addExtension(new L),t.addExtension(new F),t.addExtension(new Ct),t.addExtension(new xt),t.addExtension(new Ot),t.addExtension(new jt),t.addExtension(new Mt)}))})(),window.country=o})();