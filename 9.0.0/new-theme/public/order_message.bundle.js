 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:x}=window,O=function(t,e){x.post(t).then((()=>window.location.assign(e)))},{$:j}=window;class A{extend(t){t.getContainer().on("click",m,(t=>{O(j(t.currentTarget).data("url"),j(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:jt}=window;jt((()=>{const t=new k("order_message");t.addExtension(new C),t.addExtension(new B),t.addExtension(new A),t.addExtension(new S),t.addExtension(new I),t.addExtension(new Ot),t.addExtension(new P),t.addExtension(new Et),t.addExtension(new Bt)}))})(),window.order_message=o})();